...
class $AssetsSvgsGen {
  ...
  /// File path: assets/svgs/ticket-fill.svg
  String get ticketFill => 'assets/svgs/ticket-fill.svg';

  /// File path: assets/svgs/ticket.svg
  String get ticket => 'assets/svgs/ticket.svg';

  /// File path: assets/svgs/user-fill.svg
  String get userFill => 'assets/svgs/user-fill.svg';

  /// File path: assets/svgs/user.svg
  String get user => 'assets/svgs/user.svg';

  /// File path: assets/svgs/users-fill.svg
  String get usersFill => 'assets/svgs/users-fill.svg';

  /// File path: assets/svgs/users.svg
  String get users => 'assets/svgs/users.svg';
